...
-- Zrzut struktury tabela TMS_DEV.remote_Device_Types
CREATE TABLE IF NOT EXISTS `remote_Device_Types` (
  `Type_ID` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(30) NOT NULL DEFAULT '',
  PRIMARY KEY (`Type_ID`) USING BTREE
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='linked/Device_Types';
