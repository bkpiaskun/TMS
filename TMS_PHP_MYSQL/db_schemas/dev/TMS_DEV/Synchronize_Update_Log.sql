...
-- Zrzut struktury procedura TMS_DEV.Synchronize_Update_Log
DELIMITER //
CREATE PROCEDURE `Synchronize_Update_Log`()
BEGIN
	Insert INTO TMS_DEV.Update_Log
	SELECT rsr.*
	...
	SELECT CONCAT(FOUND_ROWS(),' rekordów zsynchronizowane'),'SynchroFW_IN';
	END IF;
END//
DELIMITER ;
